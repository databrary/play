...
exports.publish = function(taffyData, opts, tutorials) {
    ...
    Object.keys(helper.longnameToUrl).forEach(function(longname) {
        ...
        if (myModules.length) {
            generate('Directive: ' + myModules[0].name, myModules, helper.longnameToUrl[longname]);
        }
        ...
        if (myNamespaces.length) {
            generate('Service: ' + myNamespaces[0].name, myNamespaces, helper.longnameToUrl[longname]);
        }
