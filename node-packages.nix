...
let
  sources = {
    ...
    "caniuse-lite-1.0.30000874" = {
      ...
      src = fetchurl {
        url = "https://registry.npmjs.org/caniuse-lite/-/caniuse-lite-1.0.30000874.tgz";
        sha512 = "3vk8xgbfi3np1mrlpbgfampp8f6gaa2zx1ywj4mg9i9dvbk47m5fqyba7wn076h2n6n33zwjbkpws5pjd4v1iq19k4hl7z28gafpnfv";
      };
    };
    "center-align-0.1.3" = {
      name = "center-align";
    ...
    "pivottable-2.21.0" = {
      ...
      version = "2.21.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/pivottable/-/pivottable-2.21.0.tgz";
        sha1 = "fa510119f5f9181ce0521cc44b2d51c60b37d528";
      };
    };
    "postcss-6.0.1" = {
      name = "postcss";
        ...
        dependencies = [
          (sources."autoprefixer-7.1.0" // {
            dependencies = [
              ...
              sources."caniuse-lite-1.0.30000874"
