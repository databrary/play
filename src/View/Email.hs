      ...
      H.tr $
        H.td $ do
          ...
          H.p $ do
            ...
            H.br
            H.a H.! HA.href "https://www.databrary.org" $
              "www.databrary.org"
      H.tr $
        H.td H.! HA.class_ "footer" $
          htmlSocialMedia
...
emailNewlyAuthorized = emailTemplate $ do
  ...
  H.p $ do
    ...
    H.a H.! HA.href "https://databrary.org/access/policies/release-template.html" $
      "Databrary Release"
